...
def basic_query(tables:list, destination:str='network', start_ts:str=None, end_ts:str=None, limit:int=0):
    ...
    query += f" select timestamp, millitm, status, marker, val from {base_table}"
...
for i in range(28, 40):
    tables.append(f't{i}')
raw_data = basic_query(tables=tables, destination='network', start_ts='2025-02-02 00:00:00', end_ts='2025-02-05 23:59:59', limit=1000)
print
